...
/* ---------------------- Función de modelos, importación ----------------------*/
...
function models() {
  ...
  loader.load("/models/carros/carro1.gltf", (result) => {
    ...
    carrito1.scale.set(0.7, 0.2, 0.7);
...
window.addEventListener("resize", () => {
  ...
  (sizes.height = window.innerHeight * 0.93),
    // Update camera
...
// update render de la escena
renderer.setSize(sizes.width, sizes.height);
renderer.setPixelRatio(Math.min(window.devicePixelRatio, 2));

// ayuda para coordenadas (axes x, y & z)
...
// exportar los siguientes elementos para otros archivos de configuración
